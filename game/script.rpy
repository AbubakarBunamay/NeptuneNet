...
label start:
    ...
    # Susan thought  
    show susan
    voice "audio/day1/Scene3_N3_smt.mp3"
    ...
    show susan
    voice "audio/day1/scene5_N3_smt.mp3"
    ...
    #Michael McQuaid
    show michael 
    #voice "audio/day1/scene7_N2_mm8.mp3" #old version
    mm "Ah, and here’s dinner now!"
    hide michael
    
    #Susan Thoughts 
    show susan
    #voice "audio/day1/scene7_N3_smt_1.mp3"
    ...
    #Narrator 
    #voice "audio/day1/scene7_N1_6.mp3" #canot find audio file yet
    ...
    #Ezekiel Jones 
    show ezekiel at right
    #voice "audio/day1/scene7_N9_ej_7_3.mp3" #file not found yet
    ...
    menu scene_7_choice:
        ...
        "Go Mingle":
            ...
            #Susan Murphy 
            show susan
            #voice "audio/day1/scene7_N5_sm4.mp3" #the file is not the updated text from Zeik to Ezeikeil Caleb Nov 15
...
label first_murder:   
    ...
    menu ezekiel_inv:
        ...
        "Ask About Footprint":
            ...
            #Ezekiel Jones
            #voice "audio/day2/scene31_n9_ej_1.mp3"
...
label third:
    ...
    show ezekiel questioning at left
    ej "Sure…"
    hide ezekiel
...
label day3_cont:   
    ...
    sm "I'm guessing most people didn't like the taste."
    ...
    menu deck_inv:
        ...
        "Ask About Whereabout":
            ...
            #voice "audio/scene68_N5_sm_1.mp3"
            ...
            #voice "audio/scene68_N5_sm_2.mp3"

            #Ezekiel Jones
            #voice "audio/scene68_N9_ej_2.mp3"
...
label thirdmurder:
    ...
    sm "So they're smart enough to cover their tracks, to confuse whoever investigates. Clearly, whoever did it wanted us to think it was one of those two."
...
label finale:
    ...
    "Susan and Ezekiel sprint down the hall, practically fly down the stairs into the hold, where they discover a bomb strapped to the engine."
