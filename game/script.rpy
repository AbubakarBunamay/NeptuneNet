...
label mingle:
    ...
    smt "Building a list? Why would he possibly be building a list on me? Ugg I can’t ever get a vacation. I should probably check on Rachel. I wonder where she ran off to."
    hide susan 
...
label first_murder:   
    ...
    #Deborah
    show deborah
    voice "audio/day2/scene24_N12_dw_1.mp3"
    dw "That's it, it's okay. Let it out."
    hide deborah

    #Susan Murphy
    show susan at left
    voice "audio/day2/scene24_N5_sm_1.mp3"
    sm "Hello? Patricia, Deborah. You gals doing okay?"
    hide susan

    #Deborah White
    show deborah at right
    voice "audio/day2/scene24_N12_dw_2.mp3"
    ...
    #Deborah White
    show deborah at right
    voice "audio/day2/scene24_N12_dw_3.mp3"
    ...
    #Susan Murphy
    show susan at left
    voice "audio/day2/scene24_N5_sm_2.mp3"
    ...
    voice "audio/day2/scene24_N12_dw_5.mp3"
    dw  "Yea, we found her. Thank goodness she was okay. Physically, at least."
    hide deborah

    #Susan Murphy
    show susan at left
    voice "audio/day2/scene24_N5_sm_4.mp3"
    sm "Where was she?"
    hide susan

    #Deborah White
    show deborah at right
    voice "audio/day2/scene24_N12_dw_6.mp3"
    ...
    #Susan Murphy
    show susan at left
    voice "audio/day2/scene24_N5_sm_5.mp3"
    sm "Did you tell her?"
    hide susan

    #Deborah White
    show deborah at right
    voice "audio/day2/scene24_N12_dw_7.mp3"
...
label cont_ezekiel_inv:
    ...
    scene hallway
    show susan at left 
    voice "audio/day2/scene35_n5_sm_2.mp3"
    ...
    menu ezekiel_training:
        ...
        "Press Further":
            ...
            show susan at left
            show ezekiel at right
            voice "audio/day2/scene36_n5_sm.mp3"
            ...
            #Susan Murphy 
            voice "audio/day2/scene36_n5_sm_2.mp3"
            ...
            #Susan Murphy
            voice "audio/day2/scene36_n5_sm_3.mp3"
            sm "I apologize, Ezekiel. I know I was rough with asking questions."

            #Narrator
            voice"audio/day2/scene36_N1_1.mp3"
            "Ezekiel tries to calm himself down."

            #Ezekiel Jones
            voice "audio/day2/scene36_n9_ej_5.mp3"
        ...
        "Ask calmly":
            ...
            #Ezekiel Jones
            voice "audio/day2/scene37_n9_ej.mp3"
            ...
            #Ezekiel Jones
            voice "audio/day2/scene37_n9_ej_4.mp3"
...
label dalton_inv:
    ...
    #David Dalton 
    show david
    voice "audio/day2/Scene38_n4_dd.mp3" 
    ...
    #David Dalton 
    voice "audio/day2/Scene38_n4_dd_2.mp3"
    ...
    menu ask_dalton:
        ...
        "Ask about footprint":
            ...
            hide susan
            show david 
            voice "audio/day2/scene38_n1.mp3"
            ...
            #Narrator
            voice "audio/day2/scene39_N1_4.mp3"
        ...
        "Ask about whereabouts":
            ...
            menu dalton_whereabouts:
                ...
                "Press Further":
                    ...
                    #David Dalton
                    show david 
                    voice "audio/day2/scene41_n4_dd.mp3"
                    ...
                    #David Dalton 
                    show david
                    voice "audio/day2/scene41_n4_dd_2.mp3"
...
label william_kitchen:
    ...
    "Moments after Susan arrives, William Windchime walks into the kitchen."
    hide william

    #Susan Murphy 
    show susan at left
    voice "audio/day2/scene42_n5_sm.mp3"
    ...
    #Ezkeiel Jones
    show ezekiel at right
    voice "audio/day2/scene42_n9_ej.mp3"
    ...
    menu windchime_inv:
        ...
        "Asking about footprint":
            ...
            #Susan Murphy 
            show susan at left
            voice "audio/day2/scene43_n5_sm_2.mp3"
            ...
            #Ezekiel Jones
            show ezekiel at right
            voice "audio/day2/scene43_n9_ej_2.mp3"
            ...
            #Susan Murphy 
            show susan at left
            voice "audio/day2/scene43_n5_sm_3.mp3"
            ...
            #Susan Murphy
            show susan at left
            voice "audio/day2/scene43_n5_sm_4.mp3"
            sm "It's a match!"
            hide susan
            ...
            #Ezekiel Jones
            show ezekiel at right
            voice "audio/day2/scene43_n9_ej.mp3"
        ...
        "Asking about wherabouts":
            ...
            menu windchime_whereabouts:
                ...
                "Investigate Motive":
                    ...
                    #William Windchime
                    voice "audio/day2/scene47_n8_ww_4.mp3"
                    ww "Well- um-"

                    #Narrator
                    voice "audio/day2/scene47_N1_2.mp3"
                    play sound "audio/sfx/scene47_male_sigh.mp3"
                    "William sighs."

                    #William Windchime
                    voice "audio/day2/scene47_n8_ww_5.mp3"
...
label michael_inv:
    ...
    #Michael Mcquaid
    show michael
    voice "audio/day2/scene48_n2_mm.mp3"
    ...
    menu mcquaid_inv:
        ...
        "The Reeds":
            ...
            #Narrator
            voice "audio/day2/scene49_n1.mp3"
            "The party's host hesitates for a moment."

            #Michael Mcquaid
            voice"audio/day2/scene49_n2_mm3.mp3"
...
label end_of_dayone:
    ...
    #Narrator
    voice "audio/day2/scene52_n1.mp3"
    ...
    #Susan Murphy 
    show susan
    voice "audio/day2/scene54_n5_sm.mp3"
    ...
    sm  "Looks like the mystery continues."

    #Michael Mcquaid
    stop sound
    hide ezekiel
    show michael at right
    voice "audio/day2/scene55_n2_mm.mp3"
    mm "Okay, the detectives are here. Let's let them do their work."

    #Susan Murphy 
    voice "audio/day2/scene55_n5_sm2.mp3"
    sm "Wait, where is the girl that found him here?"

    #Michael Mcquaid
    voice "audio/day2/scene55_n2_mm2.mp3"
...
label third:
    ...
    #Ezekiel Jones
    voice "audio/day3/scene59_N9_ej.mp3"
    ej "Sure…"
    hide ezekiel
    ...
    #Michael Mcquaid
    stop sound
    voice "audio/day3/scene59_N2_mm2.mp3"
    ...
    voice "audio/day3/scene59_N2_mm_3.mp3"
    ...
    voice "audio/day3/scene60_N2_mm_3.mp3"
    ...
    voice "audio/day3/scene60_N2_mm_5.mp3"
...
label day3_cont:   
    ...
    #Rachel Reed
    voice "audio/day3/scene64_N11_rar2.mp3"
    rar "I guess."
    ...
    #Susan Murphy
    voice "audio/day3/scene65_N5_sm_2.mp3" 
    sm "Did you misplace it at any time?"
    

    #Rachel Reed
    voice "audio/day3/scene65_N11_rar_3.mp3"
    ...
    #Susan Murphy
    voice "audio/day3/scene66_N5_sm_1.mp3" 
    sm "Is it okay if I ask about Richard?"
    

    #Rachel Reed
    voice "audio/day3/scene66_N11_rar_1.mp3"
    rar "*Nods* Hmm-hmm."
    

    #Susan Murphy 
    voice "audio/day3/scene66_N5_sm_2.mp3"
    sm "How long have you known each other?"
    

    #Rachel Reed
    voice "audio/day3/scene66_N11_rar_2.mp3"
    ...
    #Rachel Reed
    voice "audio/day3/scene66_N11_rar_3.mp3"
    ...
    #Rachel Reed
    voice "audio/day3/scene66_N11_rar_4.mp3"
    rar "That's why you're the detective."
    
    voice "audio/day3/scene66_N11_rar_5.mp3"
    rar "Are we done yet? I would like to go and lay back down again."
    

    #Susan Murphy 
    voice "audio/day3/scene66_N5_sm_5.mp3"
    sm "Sure, that's all I wanted to ask."
    

    #Rachel Reed
    voice "audio/day3/scene66_N11_rar_6.mp3"
    rar "Bye.."
    ...
    #Susan Murphy 
    show susan at left
    voice "audio/day3/scene67_N5_sm_1.mp3"
    ...
    #Ezekiel Jones
    voice "audio/day3/scene67_N9_ej_2.mp3"
    ...
    menu deck_inv:
        ...
        "Ask About Whereabouts":
            ...
            menu ej_wh_choice:
                ...
                "Press further":
                    ...
                    #Susan Murphy 
                    voice "audio/day3/scene69_N5_sm2.mp3"
        ...
        "Probe for motive":
            ...
            show susan at left
            show ezekiel at right
            voice "audio/day3/scene70_N5_sm1.mp3"
            sm "Did you notice any changes in behaviour from William?"

            #Ezekiel Jones
            voice "audio/day3/scene70_N9_ej.mp3"
            ...
            menu motive_inv:
                ...
                "Press Further":
                    ...
                    show susan at left
                    show ezekiel at right
                    voice "audio/day3/scene71_N5_sm1.mp3"
                    ...
                    #Ezekiel Jones
                    voice "audio/day3/scene71_N9_ej3.mp3"
                    ej "You're Welcome."
                    hide susan
                    hide ezekiel
                ...
                "Calm him down":
                    ...
                    #Ezekiel Jones
                    voice "audio/day3/scene72_N9_ej3.mp3"
                    ej "My pleasure."
                    hide susan
                    hide ezekiel        
    ...
    menu dalton_pathIvestigation:
        ...
        "Ask About Whereabouts":
            ...
            voice "audio/day3/scene74_N5_sm_4.mp3"
            sm "Convenient enough that it beggars' belief, some might say."
            hide susan

            #Ezekiel Jones
            show ezekiel at left
            voice "audio/day3/scene74_N9_ej_1.mp3"
            ...
            hide ezekiel
            show susan at left
            voice "audio/day3/scene74_N5_sm_5.mp3"
            sm "I think he got the point." 
            

            #David Dalton
            voice "audio/day3/scene74_N4_dd_3.mp3"
            ...
            menu daltonchoice_whereabouts:
                ...
                "Press Further":
                    ...
                    #Susan Murphy
                    voice "audio/day3/scene75_N5_sm2.mp3"
                    sm "No, no! I'm just trying to eliminate possibilities!"
                    hide david

                    #David Dalton
                    show david smiling at right
                    voice "audio/day3/scene75_N4_dd2.mp3"
                    ...
                    #Narrator
                    voice "audio/day3/scene75_N1_2.mp3"
                    "Dalton gives Susan a dark look."

                    #David Dalton
                    voice "audio/day3/scene75_N4_dd3.mp3"
...
label probemotive:
    ...
    #David Dalton
    voice "audio/day3/scene76_N4_dd_1.mp3"
    dd "What do you mean, Ms. Murphy?"
    

    #Susan Murphy
    voice "audio/day3/scene76_N5_sm_2.mp3"
    ...
    menu dalton_motive_choice:
        ...
        "Press Further":
            ...
            #Ezekiel Jones
            show ezekiel at left
            voice "audio/day3/scene78_N9_ej_1.mp3"
            ej "What do you mean \"concerned\" ?"
            

            #David Dalton
            voice "audio/day3/scene78_N4_dd_2.mp3"
            ...
            #David Dalton
            voice "audio/day3/scene78_N4_dd_5.mp3"
            ...
            #Susan Murphy
            show susan at left
            voice "audio/day3/scene78_N5_sm_3.mp3"
            ...
            #Narrator 
            scene hallway
            voice "audio/day3/scene78_N1_3.mp3"
            "Susan and Ezekiel rocket down the hallway."
...
label thirdmurder:
    ...
    #Narrator
    voice "audio/day4/scene82_N1_1.mp3"
    ...
    voice "audio/day4/scene82_N5_sm_6.mp3"
    hide susan
    ...
    scene d_h_bsusan
    show susan
    voice "audio/day4/Scene83_N5_sm.mp3"
    ...
    voice "audio/day4/scene83_N5_sm_6.mp3"
    ...
    voice "audio/day4/scene83_N2_mm_6.mp3"
    ...
    voice "audio/day4/scene83_N2_mm_13.mp3"
    ...
    voice "audio/day4/scene83_N2_mm_14.mp3"
    ...
    menu killer_choice:
        ...
        "David Dalton":
            ...
            voice "audio/day4/scene84_N4_dd_5.mp3"
            ...
            voice "audio/day4/scene84_N4_dd_6.mp3"
        ...
        "Michael McQuiad":
            ...
            #Susan Murphy 
            show susan 
            voice "audio/day4/scene85_N5_sm_1.mp3"
...
label finale:
    ...
    #Susan Murphy 
    show susan
    voice "audio/day4/scene89_N5_sm_1.mp3"
    ...
    #Susan Murphy
    show susan at left
    voice "audio/day4/scene90_N5_sm_1.mp3" 
    sm "There it is!"
    ...
    show ezekiel at right
    show susan at left
    voice "audio/day4/scene91_N9_ej_1.mp3"
    ...
    menu defuse_bomb:
        ...
        "{color=#0000ffff}Blackmail{/color}":
            ...
            #Narrator
            voice "audio/day4/scene92_N1_2.mp3"
            "Others are drowned, caught in Neptune's Net."
            

            #Narrator
            voice "audio/day4/scene92_N1_3.mp3"
        ...
        "{color=#f00}Revenge{/color}":
            ...
            #Susan Murphy 
            show susan at left
            voice "audio/day4/scene93_N5_sm_1.mp3"
            ...
            menu dalton_location:
                ...
                "Helm":
                    ...
                    #Narrator
                    voice "audio/day4/scene95_N1_1.mp3" 
                    ...
                    voice "audio/day4/scene96_N4_dd_2.mp3"
                    show david 
                    ...
                    #Ezekiel Jones
                    show ezekiel
                    voice "audio/day4/scene96_N9_ej_1.mp3"
                    ...
                    sm "Those will do. Put him in one and our illustrious host in the other. Then when we get back to Honolulu, we can hand them over to the authorities."
                    hide susan
                    ...
                    voice "audio/day4/scene97_N1_2.mp3"
